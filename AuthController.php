...
class AuthController extends Controller
{
    ...
    public function forget_password(Request $request)
    {
        try 
        {
            ...
            if(count($user) == 0)
            {
                return Response::json(['data'=> 'Email not exist', 'status_code'=> 404, 'status' => true],404);
            }
            ...
            Mail::to($user->email)->send(new ForgetPassword($host, $user,$randomString));
            return Response::json(['data'=> 'Email send please check to update new password', 'status_code'=> 200, 'status' => true],200);  
        } 
        catch (Exception $e) 
        {
